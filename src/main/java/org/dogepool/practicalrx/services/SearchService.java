...
public class SearchService {
	 ...
	 *
	 * @param namePattern
	 *            the string to find in a user's displayName for him to match
	 *            (ignoring case).
	 ...
	 *
	 * @param minCoins
	 *            the minimum number of coins found by a user for it to match.
	 * @param maxCoins
	 *            the maximum number of coins above which a user won't be
